      ...
      child: Scaffold(
        ...
        body: BlocConsumer(
            ...
            listener: (context, state) {
              switch (state) {
                case LoadingInProgressState:
                  break;
                case FetchHomeCompletedState:
                  break;
              }
            },
                ...
                children: <Widget>[
                  Column(
                    children: <Widget>[
                      ...
                      state is FetchHomeCompletedState
                          ? Expanded(
                          child: Align(
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                padding:
                                const EdgeInsets.fromLTRB(22, 75, 22, 10),
                                        ...
                                        slivers: [
                                          SliverList(
                                              delegate: SliverChildBuilderDelegate(
                                                ...
                                                childCount: state.homeData[0].length,
                                              ))
                                        ],
                                      ),
                                    ),
